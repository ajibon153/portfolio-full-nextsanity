...
const Index = (props: any) => {
  ...
  const { data } = useQuery(['skill'], getSkillData, {
  ...
  const [IsLoadingExperience, setIsLoadingExperience] = useState<boolean>(true);
  ...
  const [LoadingSkills, setIsLoadingSkills] = useState<boolean>(true);
