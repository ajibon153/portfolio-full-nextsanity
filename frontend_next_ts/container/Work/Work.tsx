    ...
    const handleWorkFilter = (item: string) => {
        ...
        setTimeout(() => {
            ...
            if (item === 'All') {
                ...
                setFilterWork(
                    Works.filter((work: any) => work.tags.includes(item))
                );
            }
        }, 500);
    };
                        ...
                        >
                            {FilterWork.map((work: any, i: number) => (
                                ...
                                >
                                    ...
                                    <div
                                        className={`app__flex ${style.app__work_content}`}
                                    >
                                        ...
                                        `
                                        <div
                                            className={`app__flex ${style.app__work_tag}`}
                                        >
                                            <p className='p-text'>
                                                {work.tags[0]}
                                            </p>
